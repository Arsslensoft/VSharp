...
namespace VSC.TypeSystem.Implementation
{
	...
	/// </summary>
	[Serializable]
	public abstract class UnresolvedMemberSpec : UnresolvedEntitySpec, IUnresolvedMember
	{
		ITypeReference returnType = SpecialTypeSpec.UnknownType;
		...
		{
			var copy = (UnresolvedMemberSpec)base.Clone();
