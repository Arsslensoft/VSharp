...
namespace VSC.TypeSystem
{
	...
	public static class TypeSystemExtensions
    {
		...
		{
			return file.GetInnermostTypeDefinition (new Location (line, column));
		}
		...
		{
			return file.GetMember (new Location (line, column));
		}
		#endregion
		...
		/// Returns an <see cref="UnknownTypeSpec"/> if the type cannot be found in this compilation.
		/// </summary>
		/// <remarks>
		...
		public static IType FindType(this ICompilation compilation, FullTypeName fullTypeName)
		{
			...
			return new UnknownTypeSpec(fullTypeName);
		}
		...
		/// In case of an error, returns <see cref="SpecialTypeSpec.UnknownTypeSpec"/>.
		/// Never returns null.
		/// </returns>
