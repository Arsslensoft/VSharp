...
namespace VSC.TypeSystem
{
	...
	public static class ReflectionHelper
	{
		...
		/// Returns <see cref="SpecialTypeSpec.UnknownType"/> if the type cannot be found in this compilation.
		/// </summary>
		/// <remarks>
		/// This method cannot be used with open types; all type parameters will be substituted
		/// with <see cref="SpecialTypeSpec.UnknownType"/>.
		/// </remarks>
		...
		static ITypeReference CreateGetClassTypeReference(string assemblyName, string typeName, int tpc)
		{
			...
			if (assemblyName != null) {
				assemblyReference = new AssemblyReferenceSpec(assemblyName);
			} else {
