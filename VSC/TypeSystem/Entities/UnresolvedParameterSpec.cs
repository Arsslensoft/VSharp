...
namespace VSC.TypeSystem.Implementation
{
	...
	/// </summary>
	[Serializable]
	public sealed class UnresolvedParameterSpec : IUnresolvedParameter, IFreezable, ISupportsInterning
	{
		...
		public UnresolvedParameterSpec()
		{
		}
		
		public UnresolvedParameterSpec(ITypeReference type, string name)
		{
			if (type == null)
		...
		bool ISupportsInterning.EqualsForInterning(ISupportsInterning other)
		{
			...
			UnresolvedParameterSpec p = other as UnresolvedParameterSpec;
