...
namespace VSC.TypeSystem.Implementation
{
	...
	/// </summary>
	[Serializable]
	public sealed class UnresolvedAttributeSpec : FreezableSpec, IUnresolvedAttribute, IFreezable, ISupportsInterning
	{
		...
		public UnresolvedAttributeSpec(ITypeReference attributeType)
		{
		...
		public UnresolvedAttributeSpec(ITypeReference attributeType, IEnumerable<ITypeReference> constructorParameterTypes)
		{
			if (attributeType == null)
				throw new ArgumentNullException("attributeType");
			this.attributeType = attributeType;
		...
		public void AddNamedFieldArgument(string fieldName, IConstantValue value)
		{
			this.NamedArguments.Add(new KeyValuePair<IMemberReference, IConstantValue>(
				new MemberReferenceSpec(SymbolKind.Field, attributeType, fieldName),
				value
			));
		}
		...
		{
			this.NamedArguments.Add(new KeyValuePair<IMemberReference, IConstantValue>(
				new MemberReferenceSpec(SymbolKind.Property, attributeType, propertyName),
				value
			));
		}
		...
		{
			UnresolvedAttributeSpec o = other as UnresolvedAttributeSpec;
		...
		{
			readonly UnresolvedAttributeSpec unresolved;
			...
			public DefaultResolvedAttribute(UnresolvedAttributeSpec unresolved, ITypeResolveContext context)
			{
