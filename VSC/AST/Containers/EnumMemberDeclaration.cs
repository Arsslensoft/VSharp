    ...
    public class EnumMemberDeclaration : ConstantDeclaration
    {
        ...
        public override bool DoResolve(ResolveContext rc)
        {
            ...
            if (ResolvedField.ConstantValue  != null)
            {
                ...
                rc.Report.Error(196, Location, "Cannot convert source type `{0}' to target type `{1}'", Initializer.UnresolvedTypeReference.ToString(), rc.CurrentTypeDefinition.EnumUnderlyingType.ToString());
            else
