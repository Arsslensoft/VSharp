...
namespace VSC.AST { 
	public class EnumMemberDeclaration : Declaration {
            ...
            [Rule("<enum member declaration> ::= <Opt Documentation>  <opt attributes> <Identifier>")]
            public EnumMemberDeclaration(OptDocumentation _OptDocumentation, OptAttributes _OptAttributes, Identifier _Identifier)
            {
                _opt_documentation = _OptDocumentation;
				_opt_attributes = _OptAttributes;
				_identifier = _Identifier;
				}
            [Rule("<enum member declaration> ::= <Opt Documentation>  <opt attributes> <Identifier> '=' <expression>")]
            public EnumMemberDeclaration(OptDocumentation _OptDocumentation, OptAttributes _OptAttributes, Identifier _Identifier, Semantic _symbol60, Expression _Expression)
            {
                _opt_documentation = _OptDocumentation;
				_opt_attributes = _OptAttributes;
				_identifier = _Identifier;
