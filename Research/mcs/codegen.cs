...
namespace Mono.CSharp
{
	...
	public class EmitContext : BuilderContext
	{
        ...
        internal Dictionary<string, LocalBuilder> LocalVariablesIdx = new Dictionary<string, LocalBuilder>();
		...
		{
            if (!LocalVariablesIdx.ContainsKey(name))
                LocalVariablesIdx.Add(name, builder);
