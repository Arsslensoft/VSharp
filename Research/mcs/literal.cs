...
namespace Mono.CSharp
{
    ...
    public class ComplexLiteral : ComplexConstant, ILiteralConstant
    {
   ...
   /*
    public class DateTimeLiteral : StringConstant, ILiteralConstant
    {
        public StringLiteral(BuiltinTypes types, string s, Location loc)
            : base(types, s, loc)
        {
    ...
    public class TimeSpanLiteral : StringConstant, ILiteralConstant
    {
        public StringLiteral(BuiltinTypes types, string s, Location loc)
            : base(types, s, loc)
        {
    ...
    public class QuadLiteral : StringConstant, ILiteralConstant
    {
        public StringLiteral(BuiltinTypes types, string s, Location loc)
            : base(types, s, loc)
        {
    ...
    */
    public class VLongLiteral : VLongConstant, ILiteralConstant
    {
    ...
    public class QuadLiteral : QuadConstant, ILiteralConstant
    {
    ...
    public class DateLiteral : DateConstant, ILiteralConstant
    {
    ...
    public class TimeLiteral : TimeConstant, ILiteralConstant
    {
