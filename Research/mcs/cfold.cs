						     ...
						     Constant left, Constant right, Location loc)
		{
			...
			if (lt.BuiltinType == BuiltinTypeSpec.Type.Bool && lt == rt) {
				...
				case Binary.Operator.ExclusiveOr:
					return new BoolConstant (ec.BuiltinTypes, lv ^ rv, left.Location);
                case Binary.Operator.BitwiseXnor:
                    return new BoolConstant(ec.BuiltinTypes, !(lv ^ rv), left.Location);
                case Binary.Operator.BitwiseNand:
                    return new BoolConstant(ec.BuiltinTypes, !(lv && rv), left.Location);
                case Binary.Operator.BitwiseNor:
                    return new BoolConstant(ec.BuiltinTypes, !(lv || rv), left.Location);
            ...
            case Binary.Operator.Power:
                ...
                try
                {
                    if (left is DoubleConstant)
                    {
                        ...
                        if (ec.ConstantCheckState)
                            res = checked(Math.Pow(((DoubleConstant)left).Value,
                                ((DoubleConstant)right).Value));
                        else
                            res = unchecked(Math.Pow(((DoubleConstant)left).Value,
                               ((DoubleConstant)right).Value));
                    ...
                    else if (left is FloatConstant)
                    {
                        ...
                        if (ec.ConstantCheckState)
                            res = checked(Math.Pow(a, b));
                        else
                            res = unchecked(Math.Pow(a, b));
                    ...
                    else if (left is ULongConstant)
                    {
                        ...
                        if (ec.ConstantCheckState)
                            res = (ulong)checked(Math.Pow((double)(((ULongConstant)left).Value),
                                (double)(((ULongConstant)right).Value)));
                        else
                            res = (ulong)unchecked(Math.Pow((double)(((ULongConstant)left).Value),
                               (double)(((ULongConstant)right).Value)));
                    ...
                    else if (left is LongConstant)
                    {
                        ...
                        if (ec.ConstantCheckState)
                            res = (long)checked(Math.Pow((double)(((LongConstant)left).Value),
                                (double)(((LongConstant)right).Value)));
                        else
                            res = (long)unchecked(Math.Pow((double)(((LongConstant)left).Value),
                               (double)(((LongConstant)right).Value)));
                    ...
                    else if (left is UIntConstant)
                    {
                        ...
                        if (ec.ConstantCheckState)
                            res = (uint)checked(Math.Pow((double)(((UIntConstant)left).Value),
                                (double)(((UIntConstant)right).Value)));
                        else
                            res = (uint)unchecked(Math.Pow((double)(((UIntConstant)left).Value),
                               (double)(((UIntConstant)right).Value)));
                    ...
                    else if (left is IntConstant)
                    {
                        ...
                        if (ec.ConstantCheckState)
                            res = (int)checked(Math.Pow((double)(((IntConstant)left).Value),
                               (double)(((IntConstant)right).Value)));
                        else
                            res = (int)unchecked(Math.Pow((double)(((IntConstant)left).Value),
                               (double)(((IntConstant)right).Value)));
                    ...
                    else if (left is DecimalConstant)
                    {
                        ...
                        if (ec.ConstantCheckState)
                            res = (decimal)checked(Math.Pow((double)(((DecimalConstant)left).Value),
                               (double)(((DecimalConstant)right).Value)));
                        else
                            res = (decimal)unchecked(Math.Pow((double)(((DecimalConstant)left).Value),
                               (double)(((DecimalConstant)right).Value)));
                    ...
                    {
                        throw new Exception("Unexepected power input: " + left);
                    }
                }
                catch (OverflowException)
                {
