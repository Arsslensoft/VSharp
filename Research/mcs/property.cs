...
namespace Mono.CSharp
{
	...
	abstract public class PropertyBase : PropertyBasedMember {
		...
		public class SetMethod : PropertyMethod {
			...
			static readonly string[] attribute_targets = new string[] { "method", "param", "ret" };
	...
	public class Property : PropertyBase
	{
		...
		public override bool Define ()
		{
            ...
            if ((ModFlags & Modifiers.SYNC) == Modifiers.SYNC)
                Report.Error(3661, Location, "A sync modifier cannot be used in property declaration. ");
	...
	public abstract class Event : PropertyBasedMember
	{
		...
		public override bool Define ()
		{
            ...
            // SYNC_MOD_CTRL
            if ((ModFlags & Modifiers.SYNC) == Modifiers.SYNC)
                Report.Error(3661, Location, "A sync modifier cannot be used in event declaration. ");
