...
namespace Mono.CSharp
{
	...
	public class BuiltinTypes
	{
        ...
        public readonly BuiltinTypeSpec Complex;

        public readonly BuiltinTypeSpec Quad;
        public readonly BuiltinTypeSpec VLong;
        public readonly BuiltinTypeSpec Date;
        public readonly BuiltinTypeSpec Time;
		...
		public BuiltinTypes ()
		{
            ...
            Complex = new BuiltinTypeSpec(MemberKind.Struct, "System.Rava", "Complex", BuiltinTypeSpec.Type.Complex);
            Quad = new BuiltinTypeSpec(MemberKind.Struct, "System.Rava", "Quad", BuiltinTypeSpec.Type.Quad);
            VLong = new BuiltinTypeSpec(MemberKind.Struct, "System.Rava", "VLong", BuiltinTypeSpec.Type.VLong);
            Date = new BuiltinTypeSpec(MemberKind.Struct, "System", "DateTime", BuiltinTypeSpec.Type.Date);
            Time = new BuiltinTypeSpec(MemberKind.Struct, "System", "TimeSpan", BuiltinTypeSpec.Type.Time);
			...
			types = new BuiltinTypeSpec[] {
				...
				IntPtr, UIntPtr, RuntimeFieldHandle, RuntimeTypeHandle, Exception,Complex,Date,VLong,Quad,Time };
		}
	...
	class PredefinedTypes
	{
        ...
        public readonly PredefinedType ConsoleType;
        public readonly PredefinedType ConvertType;
        public readonly PredefinedType BitConverterType;
        public readonly PredefinedType SynchronizationContextType;
        public readonly PredefinedType SendOrPostCallbackType;
        public readonly PredefinedType ThreadStartCallbackType;
        public readonly PredefinedType My;
        public readonly PredefinedType AssertionException;
		...
		public PredefinedTypes (ModuleContainer module)
		{
            ...
            ConsoleType = new PredefinedType(module, MemberKind.Class, "System", "Console");
            SynchronizationContextType = new PredefinedType(module, MemberKind.Class, "System.Threading", "SynchronizationContext");
            SendOrPostCallbackType = new PredefinedType(module, MemberKind.Delegate, "System.Threading", "SendOrPostCallback");
            ThreadStartCallbackType = new PredefinedType(module, MemberKind.Delegate, "System.Threading", "ThreadStart");
            ConvertType = new PredefinedType(module, MemberKind.Class, "System", "Convert");
            BitConverterType = new PredefinedType(module, MemberKind.Class, "System", "BitConverter");
            My = new PredefinedType(module, MemberKind.Class, "System.Rava", "My");
            AssertionException = new PredefinedType(module, MemberKind.Class, "System.Rava", "AssertionException");
			//
	...
	class PredefinedMembers
	{
        ...
        public readonly PredefinedMember<MethodSpec> Power;
        public readonly PredefinedMember<MethodSpec> CloneObject;
        public readonly PredefinedMember<MethodSpec> ConsoleRootMethod;
        public readonly PredefinedMember<MethodSpec> CWrite;
        public readonly PredefinedMember<MethodSpec> SyncContextRootMethod;
        public readonly PredefinedMember<MethodSpec> SyncContextPostMethod;
        public readonly PredefinedMember<MethodSpec> ThreadStartCallBackBeginInvokeMethod;
        public readonly PredefinedMember<MethodSpec> SendPostCallBackInvokeMethod;
        public readonly PredefinedMember<PropertySpec> SyncContextCurrent;
        public readonly PredefinedMember<FieldSpec> ConvertRootMethod;
        public readonly PredefinedMember<FieldSpec> BitConverterRootMethod;
      
        public readonly PredefinedMember<MethodSpec> ComplexCtor;
        public readonly PredefinedMember<MethodSpec> QuadCtor;
        public readonly PredefinedMember<MethodSpec> VLongParse;
        public readonly PredefinedMember<MethodSpec> TimeSpanCtor;
        public readonly PredefinedMember<MethodSpec> DateTimeParse;
        public readonly PredefinedMember<MethodSpec> AssertionExceptionCtor;
		public PredefinedMembers (ModuleContainer module)
		{
            ...
            Power = new PredefinedMember<MethodSpec>(module, types.My, "Power", btypes.Double, btypes.Double);
            CloneObject = new PredefinedMember<MethodSpec>(module, types.My, "Copy", btypes.Object);

            ConvertRootMethod = new PredefinedMember<FieldSpec>(module, types.ConvertType,
            MemberFilter.Field("DBNull", btypes.Object));
          
            DateTimeParse = new PredefinedMember<MethodSpec>(module, btypes.Date,
         MemberFilter.Method("FromBinary", 0, ParametersCompiled.CreateFullyResolved(btypes.Long), btypes.Date));

            VLongParse = new PredefinedMember<MethodSpec>(module, btypes.VLong,
         MemberFilter.Method("Parse", 0, ParametersCompiled.CreateFullyResolved(btypes.String), btypes.VLong));

            QuadCtor = new PredefinedMember<MethodSpec>(module, btypes.Quad,
  MemberFilter.Method("Parse", 0, ParametersCompiled.CreateFullyResolved(btypes.String), btypes.Quad));

            ComplexCtor = new PredefinedMember<MethodSpec>(module, btypes.Complex,
        MemberFilter.Constructor(ParametersCompiled.CreateFullyResolved(btypes.Double,btypes.Double)));
        
            AssertionExceptionCtor = new PredefinedMember<MethodSpec>(module, types.AssertionException,
        MemberFilter.Constructor(ParametersCompiled.CreateFullyResolved(btypes.String)));

            TimeSpanCtor = new PredefinedMember<MethodSpec>(module, btypes.Time,
  MemberFilter.Constructor(ParametersCompiled.CreateFullyResolved(btypes.Long)));

            BitConverterRootMethod = new PredefinedMember<FieldSpec>(module, types.BitConverterType,
                    MemberFilter.Field("IsLittleEndian", btypes.Bool));
            ConsoleRootMethod = new PredefinedMember<MethodSpec>(module, types.ConsoleType,
         MemberFilter.Method("Clear", 0, ParametersCompiled.EmptyReadOnlyParameters, types.ConsoleType.TypeSpec));

            CWrite = new PredefinedMember<MethodSpec>(module, types.ConsoleType,
                MemberFilter.Method("WriteLine", 0, ParametersCompiled.CreateFullyResolved(btypes.Object), types.ConsoleType.TypeSpec));


            SyncContextRootMethod = new PredefinedMember<MethodSpec>(module, types.SynchronizationContextType,
        MemberFilter.Method("OperationCompleted", 0, ParametersCompiled.EmptyReadOnlyParameters, types.SynchronizationContextType.TypeSpec));

            SendPostCallBackInvokeMethod = new PredefinedMember<MethodSpec>(module, types.SendOrPostCallbackType, "Invoke", btypes.Object);
            ThreadStartCallBackBeginInvokeMethod = new PredefinedMember<MethodSpec>(module, types.ThreadStartCallbackType, "BeginInvoke", types.AsyncCallback.Resolve(), btypes.Object);

            SyncContextPostMethod = new PredefinedMember<MethodSpec>(module, types.SynchronizationContextType, "Post", types.SendOrPostCallbackType.Resolve(), btypes.Object);

            SyncContextCurrent = new PredefinedMember<PropertySpec>(module, types.SynchronizationContextType,
            MemberFilter.Property("Current", types.SynchronizationContextType.TypeSpec));
		}
	}
