...
namespace Mono.CSharp
{
	...
	abstract class AssemblyReferencesLoader<T> where T : class
	{
        ...
        protected void LoadReferencesCore(ModuleContainer module, out T corlib_assembly, out T ravalib_assembly, out List<Tuple<RootNamespace, T>> loaded)
		{
			...
			//
            ravalib_assembly = LoadAssemblyFile("System.Rava.dll", true);
