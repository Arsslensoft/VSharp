...
namespace Mono.CSharp
{
	...
	public abstract class TypeContainer : MemberCore
	{
        ...
        internal List<FieldSpec> SynchronizedFields { get; set; }
	...
	public abstract class TypeDefinition : TypeContainer, ITypeDefinition
	{
		...
		public sealed override bool Define ()
		{
			...
			base.Define ();
         // SYNC_MOD_CTRL
            if ((Definition.Modifiers & Modifiers.SYNC)== Modifiers.SYNC)
                Report.Error(3661, Location, "A sync modifier cannot be used in type definition (class/struct/interface). ");
