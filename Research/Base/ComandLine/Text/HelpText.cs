...
namespace VSC.Base.CommandLine.Text
{
    ...
    public class HelpText
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VSC.Base.CommandLine.Text.HelpText"/> class.
        /// </summary>
        public HelpText()
        {
        ...
        /// </summary>
        /// <param name="heading">An heading string or an instance of <see cref="VSC.Base.CommandLine.Text.HeadingInfo"/>.</param>
        ...
        /// <param name="heading">A string with heading or an instance of <see cref="VSC.Base.CommandLine.Text.HeadingInfo"/>.</param>
        ...
        /// </summary>
        /// <param name="heading">A string with heading or an instance of <see cref="VSC.Base.CommandLine.Text.HeadingInfo"/>.</param>
        /// <param name="copyright">A string with copyright or an instance of <see cref="VSC.Base.CommandLine.Text.CopyrightInfo"/>.</param>
        ...
        /// You can directly assign a <see cref="VSC.Base.CommandLine.Text.HeadingInfo"/> instance.
        /// </summary>
        ...
        /// You can directly assign a <see cref="VSC.Base.CommandLine.Text.CopyrightInfo"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="VSC.Base.CommandLine.Text.HelpText"/> class using common defaults.
        /// </summary>
        /// <returns>
        /// An instance of <see cref="VSC.Base.CommandLine.Text.HelpText"/> class.
        /// </returns>
        /// <param name='options'>The instance that collected command line arguments parsed with <see cref="Parser"/> class.</param>
        ...
        /// </summary>
        /// <param name="options">The instance that collects parsed arguments parsed and associates <see cref="VSC.Base.CommandLine.ParserStateAttribute"/>
        /// to a property of type <see cref="IParserState"/>.</param>
        /// <param name="current">The <see cref="VSC.Base.CommandLine.Text.HelpText"/> instance.</param>
        ...
        /// </summary>
        /// <param name="info">This <see cref="VSC.Base.CommandLine.Text.HelpText"/> instance.</param>
        ...
        /// </summary>
        /// <param name="options">An options target instance that collects parsed arguments parsed with the <see cref="VSC.Base.CommandLine.ParserStateAttribute"/>
