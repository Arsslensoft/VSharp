...
namespace VSC.Base.CommandLine.Text
{
    ...
    public class CopyrightInfo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VSC.Base.CommandLine.Text.CopyrightInfo"/> class
        ...
        /// </summary>
        /// <param name="info">This <see cref="VSC.Base.CommandLine.Text.CopyrightInfo"/> instance.</param>
